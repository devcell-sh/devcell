...
// variant_test.go — CELL-108 image variant discovery for tests.
//
...
// suite — so pure-variant regressions ship undetected (see CELL-85 PATH
...
//
// Path (a) of the CELL-108 plan: test code only. CI matrix extension to
